...
class ModelHandler():
    def __init__(self, model_type: str, model_path: str,
                 length:int, stop_token: str, temperature: float = 1.0,
                 repetition_penalty: float = 1.0, k: int = 0, p: float = 0.9,
                 prefix: str = '[Title:]', xlm_language: str = '',
                 seed: int = 42, no_cuda: bool = True, num_return_sequences: int = 1,
                 fp_16: bool = True):
